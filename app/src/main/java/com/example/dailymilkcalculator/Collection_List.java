...
public class Collection_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView)findViewById(R.id.collection_list);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Collection_List.this,Transaction.class);
    ...
    protected void onResume() {
        ...
        if (folder.exists()) {
            ...
            final ListView lv = findViewById(R.id.collection_list);
